...
export class RecipeListComponent {
 ...
 @Output() recipeWasSelected = new EventEmitter<Recipe_m>();
  recipes_A : Recipe_m[] =[
    new Recipe_m('pizza',
  ...
  ,  new Recipe_m('Tomato Pie with Parmesan and Basil',
   ...
   , new Recipe_m('Fruit Pizza', 'Colorful fruit pizza features a vibrant bounty of fruit atop a soft sugar cookie crust and thick, ...', 'https://bakingamoment.com/wp-content/uploads/2019/07/IMG_5499-fruit-pizza.jpg')
  ];


  onRecipeItemSelected(recipe:Recipe_m){
